...
from .views import (relatorios_view, criar_agendamento, criar_cliente, criar_servico, register_view, logout_view, login_view, dashboard, clientes_view, agendamentos_view,)
